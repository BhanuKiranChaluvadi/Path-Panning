...
'''
    ...
    while (n_0.state != init_pos):
        ...
        n_0 = n_0.parent
    # I filled U!!!!
    path = path[::-1]       # i am reversing the path i.e going initial to final position
    action_path = action_path[::-1]  # revesing the action i.e going to intial to final positons
...
'''
    ...
    while (n_0.state != init_pos):
        path.append( n_0.parent.state)
        action_path.append((n_0.parent.parent_action))
        n_0 = n_0.parent
    # I filled U!!!!
    path = path[::-1]
    return (path, action_path
